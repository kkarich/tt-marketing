    ...
    <Layout showFooter={false}>
      <div className="relative flex h-full items-center py-20 sm:py-36">
        ...
        <Container className="relative flex w-full flex-col items-center">
          <p className="font-display text-2xl tracking-tight text-cyan-900">
            404
          </p>
          <h1 className="mt-4 font-display text-4xl font-medium tracking-tighter text-cyan-600 sm:text-5xl">
            Page not found
          </h1>
